class Subversionutf8 < Formula
  ...
  bottle do
    revision 1
    sha256 "55926084ec963a64b96e2abe01ce0ba86a64fbfebcc7aab5afc155b37fd76066" => :sierra
  ...
  if build.with? "unicode-path"
    patch :p0 do
      url "https://raw.githubusercontent.com/kosukeohatabita/homebrew-misc/master/svn_1.8.x_darwin_unicode_precomp.patch"
    end
  end
